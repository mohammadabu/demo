...

{
    ...
    'data': [
        ...
        'wizard/account_aged_balance_wizard.xml',
        ...
        'report/report_account_aged_balance.xml',
        'report/report_aged_balance_print.xml',
        'views/account_aged_balance_view_button.xml',  
    ],
    'qweb': [
