...
class Purchaserequester(models.Model):
    ...
    product_requester_ids = fields.One2many('purchase.requester.lines', 'product_requester_id', string='Products')
...
class PurchaseRequestProducts(models.Model):
    _name='purchase.requester.lines'
    _description = 'Purchase Request Lines'

    product_id = fields.Many2one('product.product', string='Product')
    product_qty = fields.Float(string='Quantity', digits='Product Unit of Measure',)
    product_uom = fields.Many2one('uom.uom', string='Unit of Measure')
    product_requester_id = fields.Many2one('purchase.requester', string='Purchase Request Reference')
