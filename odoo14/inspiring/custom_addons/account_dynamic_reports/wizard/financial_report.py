...
class InsFinancialReport(models.TransientModel):
    ...
    _description = "Dynamic Financial Reports"
    ...
    def get_account_lines(self, data):
        ...
        for report in child_reports:
            # To remove the income line from report
            if report.id == 2 or report.name == "Income":
                continue
    ...
    def action_xlsx(self):
        ...
        report_id = self.env['common.xlsx.out'].sudo().create({'filedata': result, 'filename': 'FIN.xlsx'})
