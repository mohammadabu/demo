...
class SalesOrder(models.Model):
    ...
    delivery_status = fields.Selection(selection=[
        ...
        ('out_to_deliver', 'Out to Deliver'), ('partial', 'Partially Deliver'), 
        ('delivered', 'Delivered'), ('postponed', 'Postponed'), 
        ('returned', 'Returned'), ('processing', 'Processing'), 
        ('pick_up', 'Pick Up')
    ], string='Delivery Status', store=True,
        copy=False, default='nothing')
