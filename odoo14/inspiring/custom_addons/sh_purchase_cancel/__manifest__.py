...

{
    ...
    "category": "Purchases",
    "license": "OPL-1",
    "summary": "Cancel Purchase Orders, Cancel Purchase Order, Cancel PO,Purchase Order Cancel, Purchase Orders Cancel, Cancel RFQ, Cancel Request For Quotation,Purchase Cancel, Cancel RFQs, Delete Purchase Order,Delete PO,Delete RFQ, Remove Purchase Odoo",
    "description": """
